...
请follow我们最新的进度\href{https://github.com/Tr0py/NKU-thesis-template-2020}{https://github.com/Tr0py/NKU-thesis-template-2020}, 以获取最新的模板bug修复及更新。如有问题请在GitHub留言，我们会尽快回复。欢迎加入毕业论文模板维护的工作中:).


\iffalse
本模板的发展历史：
\begin{enumerate}
    \item 南开大学孙文昌老师制作了南开大学研究生论文\LaTeX模板
    \item 南开大学08级本科生卓小杨修改制成本科生毕业论文模板
\end{enumerate}


然而安装\LaTeX 环境以及编译并不那么简单，会有一些出乎意料的bug。为方便使用\LaTeX ，支持在线和跨平台编译修改毕业论文，我们将模板移植到了在线的\LaTeX 平台Overleaf上并做了更新。
...
\hskip 20em 16级本科生\quad 赵子懿\quad 潘宇


\section{系统要求}

模板仅在 CTex2.9.2 下测试\XeLaTeX 通过。对于其它 TeX 发行版可能需要做个别修改。本模板改编自孙老师（http://222.30.48.141/$\sim$sunwch）的版本，格式参照南开大学2019年毕业论文格式。
...
文献\upcite{ZhuKeZhen,Huo}\cite{JiangXiZhou,Timoshenko,Zhang-Wang}
\cite{ZhuKeZhen}
测试\cite{PQEMU}或者\cite{li1988ivy}
